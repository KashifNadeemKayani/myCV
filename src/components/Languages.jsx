    ...
    <section className="my-5">
      ...
      <div className={styles.skillsContainer}>
        <ul className="list-group list-group-flush text-center">
          ...
          <div className={`${styles.progressBarContainer} progress`} role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
            <div className={`progress-bar progress-bar-striped progress-bar-animated ${styles.progressBar}`} style={{ width: '95%' }}></div>
          </div>
