...
//             <p>Mechanical Engineering, Bachelor of Engineering<br />Currently studying with a CGPA of 3.42<br />Sep.2023 - Present</p>
//             <a
//               href={transcript} target="_blank" rel="noopener noreferrer"

//             // onClick={() => {alert("2nd Semester Transcript is not Available, Showing you 1st semester Transcript"); }}
//             >
...
function Education() {
  ...
  {/* <hr> after 1st card - only visible on mobile */}
  ...
  {/* <hr> after 2nd card - only visible on mobile */}
  <hr className="d-block d-md-none my-4" />
