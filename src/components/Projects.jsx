...
// import FusionViewer from './FusionViewer';
...
//       </div>
//       {/* Fusion 360 Projects */}
//       <div className={`${styles.projectAccordion} accordion mt-4`} id="fusionProjects">
//         <div className="accordion-item">
//           <h2 className="accordion-header" id="fusionHeading">
//             <button
//               className="accordion-button collapsed"
//               type="button"
//               data-bs-toggle="collapse"
//               data-bs-target="#fusionCollapse"
//               aria-expanded="false"
//               aria-controls="fusionCollapse"
//             >
//               Fusion 360 Projects
//             </button>
//           </h2>
...
//             id="fusionCollapse"
//             className="accordion-collapse collapse"
//             aria-labelledby="fusionHeading"
//             data-bs-parent="#fusionProjects"
//           >
//             <div className="accordion-body">
//               <strong>Project 1: Bolt Design</strong>
//               <p>A simple mechanical bolt created using Fusion 360.</p>
//               <FusionViewer modelPath="/models/bolt.glb" />

//               <hr />

//               <strong>Project 2: Ice Cube Tray</strong>
//               <p>A household ice cube tray modeled in 3D CAD for design optimization.</p>
//               <FusionViewer modelPath="/models/ice-cube-tray.glb" />
//             </div>
//           </div>
//         </div>
//       </div>
